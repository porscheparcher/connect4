...
class Game {
  constructor(height = 6, width = 7, p1, p2, board) {
    this.height = height;
    this.players = [p1, p2]
    this.width = width;
    this.currPlayer = p1;
  ...
  checkForWin() {
    ...
    for (let y = 0; y < this.height; y++) {
      for (let x = 0; x < this.width; x++) {
        ...
        // ways to win
        this.horiz = [[y, x], [y, x + 1], [y, x + 2], [y, x + 3]];
        this.vert = [[y, x], [y + 1, x], [y + 2, x], [y + 3, x]];
        this.diagDR = [[y, x], [y + 1, x + 1], [y + 2, x + 2], [y + 3, x + 3]];
        this.diagDL = [[y, x], [y + 1, x - 1], [y + 2, x - 2], [y + 3, x - 3]];
